...
partial class TrenirovkaForm
{
    ...
    private void InitializeComponent(){ _grid=new DataGridView(); _date=new DateTimePicker(); _time=new DateTimePicker(); _txtGroup=new TextBox(); _cmbChlen=new ComboBox(); _cmbDay=new ComboBox(); _btnAdd=new Button(); _btnEdit=new Button(); _btnDelete=new Button(); _lblGroup=new Label(); _lblDate=new Label(); _lblTime=new Label(); _lblChlen=new Label(); _lblDay=new Label(); ((System.ComponentModel.ISupportInitialize)_grid).BeginInit(); SuspendLayout();
        ...
        _cmbChlen.Location = new Point(402,38); _cmbChlen.Width=90; _cmbChlen.DropDownStyle = ComboBoxStyle.DropDownList;
        _lblDay.AutoSize = true; _lblDay.Location = new Point(512,15); _lblDay.Text = "Ден";
        _cmbDay.Location = new Point(512,38); _cmbDay.Width=90; _cmbDay.DropDownStyle = ComboBoxStyle.DropDownList;
